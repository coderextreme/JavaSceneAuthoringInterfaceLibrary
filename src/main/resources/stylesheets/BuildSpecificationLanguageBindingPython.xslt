...
<!--
  <head>
   <meta name="filename"    content="BuildSpecificationLanguageBindingPython.xslt" />
   <meta name="author"      content="Don Brutzman" />
   <meta name="created"     content="13 July 2014" />
   <meta name="description" content="XSL stylesheet to create Scene Access Interface (SAI) interfaces as Python source code matching the X3D specification." />
   <meta name="identifier"  content="http://www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingPython.xslt" />
   <meta name="reference"   content="http://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingPython.xslt?revision=9169&view=markup" />
...
-  cd   C:\www.web3d.org\x3d\stylesheets
   c:\xml\saxon\saxon ../../specifications/x3d-3.3.xsd  BuildSpecificationLanguageBindingPython.xslt
...
<xsl:message>
  <xsl:text>BuildSpecificationLanguageBindingPython: process X3D schema version </xsl:text>
  <xsl:value-of select="//xs:schema/@version"/>
  <xsl:text> using BuildSpecificationLanguageBindingPython.xslt </xsl:text>
 </xsl:message>
...
<!-- create HTML output -->
  ...
  <xsl:variable name="PythonSourceDirectoryRoot">
    <xsl:text>X3dSceneAccessInterfacesPython/</xsl:text>
  </xsl:variable>
  <xsl:variable name="ReadmeFile">
    <xsl:text>Readme.html</xsl:text>
  </xsl:variable>
  <xsl:variable name="PythonSourceDirectoryTree"> <!-- {$PythonSourceDirectoryTree} -->
...
<xsl:result-document  href="PythonLanguageBinding.Part06.nodeTypeInterfaces.html" method="html" omit-xml-declaration="yes" encoding="UTF-8" indent="yes">
...
<xsl:element name="html">
  ...
  <xsl:element name="head">
	...
	<xsl:element name="title">
		<!-- mdash = 8212 &amp;#8212;&amp;#8212; -->
		<xsl:text disable-output-escaping="yes">ISO/IEC 19777-6:20xx -- X3D Python Binding -- Annex B Node type interfaces </xsl:text>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>identifier</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>http://www.web3d.org/documents/specifications/19777-6/V3.3/Part06/nodeTypeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>http://www.web3d.org/x3d/stylesheets/PythonLanguageBinding.Part06.nodeTypeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
  ...
  <xsl:element name="body">
	...
	<xsl:text>&#10;</xsl:text>
        <xsl:comment> Autogenerated Python interface encodings for each X3D node follow </xsl:comment>
	<xsl:text>&#10;</xsl:text>
        <a name="top"/>
	<xsl:text>&#10;</xsl:text>
	...
	<xsl:element name="div">
		...
		<xsl:element name="p">
			...
			<xsl:element name="br"/>
			<xsl:text>&#10;</xsl:text>
			<xsl:text>Part 6:  Python</xsl:text>
		</xsl:element>
		<xsl:element name="p">
	...
	<xsl:text>&#10;</xsl:text>
        ...
        <p>
            ...
            the Python language syntax as would be seen in a Python source file.
        </p>
        ...
        <ul>
            ...
            <li>Fields that are represented by Python primitive value types, setter
                methods return the appropriate primitive value. </li>
            <li>Fields that are represented by Python primitive value types, getter
	...
	<xsl:for-each select="//xs:schema/xs:complexType[ends-with(@name,'Node') or (@name='X3DPrototypeInstance')]">
            ...
            <pre class="listing">
                ...
                <xsl:call-template name="python-source-from-schema-for-specification"/>
...
<pre class="listing">public interface MField extends X3DField {
	...
	<xsl:for-each select="//xs:simpleType[starts-with(@name,'SF') or starts-with(@name,'MF')]">
            ...
            <pre class="listing">
                ...
                <xsl:call-template name="python-source-from-simpleType"/>
...
<pre class="listing">public class URLUnavailableException extends X3DException
{
	...
	public URLUnavailableException(String);
        ...
        <p>
            ...
            <a href="http://www.web3d.org/specifications/Python/Part06/nodeTypeInterfaces.html">http://www.web3d.org/specifications/Python/Part06/nodeTypeInterfaces.html</a>
            <br />
            ISO-approved version online at
            <a href="http://www.web3d.org/documents/specifications/19777-6/V3.3/Part06/abstracts.html">http://www.web3d.org/documents/specifications/19777-6/V3.3/Part06/abstracts.html</a>
        </p>
        <hr />
...
<xsl:result-document  href="PythonLanguageBinding.Part06.nodeInterfaces.html" method="html" omit-xml-declaration="yes" encoding="UTF-8" indent="yes">
...
<xsl:element name="html">
  ...
  <xsl:element name="head">
	...
	<xsl:element name="title">
		<!-- mdash = 8212 &amp;#8212;&amp;#8212; -->
		<xsl:text disable-output-escaping="yes">ISO/IEC 19777-6:2014 -- X3D Python Binding -- Annex C Node interfaces </xsl:text>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>identifier</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>http://www.web3d.org/documents/specifications/19777-6/V3.3/Part06/nodeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>http://www.web3d.org/x3d/stylesheets/PythonLanguageBinding.Part06.nodeInterfaces.html</xsl:text></xsl:attribute>
	</xsl:element>
...
<p>Node interface representations in Python shall be expressed as public interfaces. </p>
...
declare methods that are not defined by the abstract node representation.</p>
	...
	<xsl:for-each select="//xs:schema/xs:element[not(@name='TODO')]">
        ...
        <p>
            ...
            and authors looking for a lightweight way to compile Script code written in Python.
            Also needed for confirming class hierarchy listings in 
            <a href="http://www.web3d.org/documents/specifications/19777-6/V3.3/Part06/compilation.html">Annex A, Constructs in Compilation Order</a>.
            See
        ...
        <p>
            ...
            <br />
            Autogenerated version online at
            <a href="http://www.web3d.org/specifications/PythonLanguageBinding/Part06/nodeInterfaces.html">http://www.web3d.org/specifications/PythonLanguageBinding/Part06/nodeInterfaces.html</a>
            <br />
            ISO-approved version online at
            <a href="http://www.web3d.org/documents/specifications/19777-6/V3.3/Part06/concretes.html">http://www.web3d.org/documents/specifications/19777-6/V3.3/Part06/concretes.html</a>
        </p>
...
<xsl:template name="python-restrictions">
    ...
    <xsl:choose>
        <xsl:when test="(string-length($restrictions) > 0) and not(@type='SFString') and not(@type='MFString')
            ...
            <!-- verbose output, pythondoc is sufficient:
...
<xsl:template name="pythonType-from-schemaType">
    <xsl:param name="schemaType" />
    <xsl:param name="default" select="@default"/>
...
<xsl:template name="python-source-from-simpleType">
    ...
    <xsl:variable name="pythonType">
        <xsl:call-template name="pythonType-from-schemaType">
            <xsl:with-param name="schemaType" select="$type"/>
        </xsl:call-template>
    </xsl:variable>
...
<xsl:text>
    ...
    public void insertValue (int imageIndex, RenderedImage value) throws ArrayIndexOutOfBoundsException;
        ...
        <xsl:otherwise>
            <xsl:text>&#10;</xsl:text>
            <!-- Pythondoc -->
            <xsl:variable name="pythondocProse">
                <xsl:text>&#160;&#160;</xsl:text>
                <xsl:text>/**</xsl:text>
                <xsl:text> Provide </xsl:text>
                <xsl:choose>
                    <xsl:when test="contains($pythonType,'[]')">
                        <xsl:text>array of </xsl:text>
                        <xsl:value-of select="$tupleNess"/>
                        <xsl:value-of select="substring-before($pythonType,'[]')"/>
                    ...
                    <xsl:otherwise>
                        <xsl:value-of select="$tupleNess"/>
                        <xsl:value-of select="$pythonType"/>
                        <xsl:if test="$isEnumerationType">
                            <xsl:text> enumeration</xsl:text>
                        </xsl:if>
                        <xsl:text> value </xsl:text>
            ...
            <xsl:value-of select="$pythondocProse"/>
            <xsl:text>&#10;</xsl:text>
            <!-- getter -->
            <xsl:text>&#160;&#160;</xsl:text>
            ...
            <xsl:choose>
                <xsl:when test="contains($type,'FVec') or contains($type,'FColor') or contains($type,'FNode')">
                    ...
                    <xsl:text> (</xsl:text>
                    <xsl:choose>
                        <!-- restore basic pythonType for SFNode/MFNode in case overridden by schema; a prototype instance might be returned -->
                        <xsl:when test="($type='SFNode')">
                            <xsl:text>X3DNode</xsl:text>
                        </xsl:when>
                        <xsl:when test="($type='MFNode')">
            ...
            <xsl:if test="(@name='SFTime')">
                ...
                <!-- getter -->
                <xsl:text>&#160;&#160;</xsl:text>
                <xsl:text>public long getPythonValue ();</xsl:text>
            <xsl:text>&#10;</xsl:text>
            </xsl:if>
            ...
            <xsl:if test="(@name='MFTime')">
                ...
                <!-- getter -->
                <xsl:text>&#160;&#160;</xsl:text>
                <xsl:text>public long get1PythonValue (int index);</xsl:text>
            <xsl:text>&#10;</xsl:text>
            </xsl:if>
            ...
            <xsl:choose>
                <xsl:when test="contains($pythonType,'|') and (@type='SFNode')">
                    <xsl:text>X3DNode</xsl:text>
                </xsl:when>
                <xsl:when test="contains($pythonType,'|') and (@type='MFNode')">
                    <xsl:text>X3DNode[]</xsl:text>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:value-of select="$pythonType"/>
            ...
            <xsl:text>)</xsl:text>
            <xsl:call-template name="python-restrictions"/>
            <xsl:text>&#10;</xsl:text>
            <xsl:if test="(@name='SFTime')">
                <!-- http://docs.oracle.com/javase/8/docs/api/java/lang/System.html#nanoTime- - (omit preceding space character from url) -->
                <xsl:text>&#10;</xsl:text>
            ...
            <xsl:if test="(@type='SFNode') and not((@name='addChildren') or (@name='removeChildren')) and (string-length(@default) > 0)">
                <xsl:text>&#10;</xsl:text>
                <xsl:value-of select="substring-before($pythondocProse,' node')"/>
...
<xsl:template name="python-source-from-schema-for-specification">
...
<xsl:template name="generate-html-meta-tags">
   ...
   [fn:month-from-date(current-date())]"/>
	...
	<xsl:element name="meta">
		...
		<xsl:attribute name="content"><xsl:text>This stylesheet generates X3D Scene Access Interface (SAI) bindings in Python the latest X3D Schema to autogenerate all interface definitions.</xsl:text>
                </xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
	...
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>X3D language bindings: Python, http://www.web3d.org/documents/specifications/19777-6/V3.3/Part06/X3D_Python.html</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>reference</xsl:text></xsl:attribute>
	...
	<xsl:element name="meta">
		...
		<xsl:attribute name="content"><xsl:text>http://www.web3D.org/x3d/stylesheets/BuildSpecificationLanguageBindingPython.xslt</xsl:text></xsl:attribute>
	</xsl:element>
	<xsl:element name="meta">
		<xsl:attribute name="name"><xsl:text>generator</xsl:text></xsl:attribute>
		<xsl:attribute name="content"><xsl:text>http://sourceforge.net/p/x3d/code/HEAD/tree/www.web3d.org/x3d/stylesheets/BuildSpecificationLanguageBindingPython.xslt?view=log</xsl:text></xsl:attribute>
	</xsl:element>
...
<xsl:template name="attribute-signature-output">
        ...
        <xsl:variable name="pythonSingletonType">
            <xsl:choose>
                <xsl:when test="contains($pythonType,'|') and (@type='SFNode')">
                    <xsl:text>X3DNode</xsl:text>
                </xsl:when>
                ...
                <xsl:when test="starts-with($pythonType,'MF')">
                    <xsl:text>S</xsl:text>
                    <xsl:value-of select="substring($pythonType,2)"/>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:value-of select="$pythonType"/>
                </xsl:otherwise>
        ...
        <xsl:if test="not($accessType='outputOnly')">
            ...
            <xsl:if test="starts-with(@type,'MF') and not(contains(@type,'Matrix')) and not(contains(@type,'Color')) and not(contains(@type,'Rotation')) and not(contains(@type,'Vec'))">
                ...
                <xsl:value-of select="$pythonSingletonType"/>
                <xsl:text> value </xsl:text>
                <!-- value restrictions, if any -->
                <xsl:choose>
                    <xsl:when test="(@name='GeoOrigin') or (@name='geoOrigin')">
                ...
                <xsl:if test="contains(@type,'FNode')">
                    <xsl:text>&#10;</xsl:text>
                    <xsl:choose>
                        <xsl:when test="contains($pythondocProse,' nodes')">
                            <xsl:value-of select="substring-before($pythondocProse,' nodes')"/>
                            <xsl:text> protoInstance</xsl:text>
                            <xsl:value-of select="substring-after($pythondocProse,' nodes')"/>
                        </xsl:when>
                        <xsl:when test="contains($pythondocProse,' node')">
                            <xsl:value-of select="substring-before($pythondocProse,' node')"/>
                            <xsl:text> protoInstance</xsl:text>
                            <xsl:value-of select="substring-after($pythondocProse,' node')"/>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:value-of select="$pythondocProse"/>
                        </xsl:otherwise>
                ...
                <xsl:if test="(@type = 'MFNode') and not(contains($pythonType,'|'))">
                    <xsl:text>&#10;</xsl:text>
                    <xsl:choose>
                        <xsl:when test="contains($pythondocProse,' nodes')">
                            <xsl:value-of select="substring-before($pythondocProse,' nodes')"/>
